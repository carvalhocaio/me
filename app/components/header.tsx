...
export function Header() {
  return (
    <header
      className="sticky top-0 z-20 flex items-center justify-between gap-5 border-b border-[var(--border)] bg-[var(--header-bg)] px-[clamp(18px,5vw,56px)] py-4 font-mono backdrop-blur-md"
    >
      <a
        href="#top"
